...
public enum BizExceptionEnum {
    ...
    PASSWORD_ERROR(100002, "The password is wrong."),
    ACCOUNT_FORBIDDEN(100003, "The account has been banned from use."),

    INVALID_FILE_NAME(100004, "Invalid file name."),

    VALIDATE_CODE_ERROR(100005, "Only 4-digit or 6-digit verification codes can be generated."),
    //通用模块
    UPDATE_ERROR(100006, "update error."),
    INPUT_ERROR(100007, "input error."),
    //员工模块
